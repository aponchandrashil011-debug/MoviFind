...
// COMPLETE READY-TO-PASTE SERVER.JS
// ========================================
    ...
    async (req, res) => {
        ...
        try {
            ...
            return res.status(500).json({
                ...
                message:
                    "Server error while loading title."
            });
        }
    }
);
...
`;
                ...
                if (
                    ...
                    console.warn(
                        "⚠️ Gemini 503. Trying fallback if available..."
                    );
        ...
        return res.status(503).json({
            ...
            message:
                lastError ||
                "Gemini Vision could not identify this title."
        });
    }
);
