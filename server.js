...
app.get("/api/movie", async (req, res) => {
    ...
    // ==================================================
    // ⚡ STEP 2 — DUPLICATE REQUEST DEDUPLICATION
    // ==================================================
    ...
    // ==================================================
    // ⚡ STEP 3 — CREATE ONE SHARED OMDb REQUEST
    // ==================================================
    ...
    // ==================================================
    // ⚡ STEP 4 — STORE REQUEST IMMEDIATELY
    // ==================================================

    movieRequestsInFlight.set(
        cacheKey,
        requestPromise
    );
    ...
    try {
        ...
        return res.status(502).json({
            ...
            message:
                error?.name === "AbortError"
                    ? "Movie service took too long to respond."
                    : "Unable to load title information right now."
        });
